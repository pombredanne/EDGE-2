...
namespace geo
{
    ...
    struct vec2t : public glm::vec2
    {
        ...
        inline friend ostream &operator <<( ostream &os, const vec2t &v ) {
            os << "{x:" << v.x;
            os << ",y:" << v.y;
            os << "}";
            return os;
    ...
    struct vec3t : public glm::vec3
    {
        ...
        template<typename ostream>
        inline friend ostream &operator <<( ostream &os, const vec3t &v ) {
            os << "{x:" << v.x;
            os << ",y:" << v.y;
            os << ",z:" << v.z;
            os << "}";
    ...
    struct vec4t : public glm::vec4
    {
        ...
        vec4t( float x, float y, float z, float w ) : glm::vec4( x, y, z, w )
        {}
        ...
        template<typename ostream>
        inline friend ostream &operator <<( ostream &os, const vec4t &v ) {
            os << "{x:" << v.x;
            os << ",y:" << v.y;
            os << ",z:" << v.z;
            os << ",w:" << v.w;
    ...
    typedef geo::vec2t<0,0>     vec2;
    typedef geo::vec3t<0,0,0>   vec3;
    typedef geo::vec4t<0,0,0,0> vec4;

    typedef geo::vec2t<0,0>   float00;
    typedef geo::vec2t<0,1>   float01;
    typedef geo::vec2t<1,0>   float10;
    typedef geo::vec2t<1,1>   float11;
    typedef geo::vec3t<0,0,0> float000;
    typedef geo::vec3t<0,0,1> float001;
    typedef geo::vec3t<0,1,0> float010;
    typedef geo::vec3t<0,1,1> float011;
    typedef geo::vec3t<1,0,0> float100;
    typedef geo::vec3t<1,0,1> float101;
    typedef geo::vec3t<1,1,0> float110;
    typedef geo::vec3t<1,1,1> float111;

    typedef geo::vec4t<0,0,0,0> float0000;
    typedef geo::vec4t<0,0,0,1> float0001;
    typedef geo::vec4t<0,0,1,0> float0010;
    typedef geo::vec4t<0,0,1,1> float0011;
    typedef geo::vec4t<0,1,0,0> float0100;
    typedef geo::vec4t<0,1,0,1> float0101;
    typedef geo::vec4t<0,1,1,0> float0110;
    typedef geo::vec4t<0,1,1,1> float0111;
    typedef geo::vec4t<1,0,0,0> float1000;
    typedef geo::vec4t<1,0,0,1> float1001;
    typedef geo::vec4t<1,0,1,0> float1010;
    typedef geo::vec4t<1,0,1,1> float1011;
    typedef geo::vec4t<1,1,0,0> float1100;
    typedef geo::vec4t<1,1,0,1> float1101;
    typedef geo::vec4t<1,1,1,0> float1110;
    typedef geo::vec4t<1,1,1,1> float1111;
