...
#if 1
#include <3rd/presto/presto.hpp>
#include <3rd/profit/profit.hpp>
#define $bench2(...) do { $ $bench( __VA_ARGS__ ); } while(0)
#endif
...
struct sdl2_filesystem : public ee::filesystem {
    ...
    void *read( const char *filename ) {
        return (void *)&preload( filename )->second[0];
    }
