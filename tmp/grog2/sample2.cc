...
std::tuple<unsigned,unsigned,unsigned> diff(std::string a, std::string b) {
  ...
  return std::tuple<unsigned,unsigned,unsigned>( c, d - c, e - c );
}

#include "bourne/bourne.hpp"

int main() {
    std::cout << bourne::to_json( diff("hello world", "helloes worlds") ) << std::endl;
