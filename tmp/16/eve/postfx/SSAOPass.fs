...
{
    if (GL_TEXCOORD.x<0.0||GL_TEXCOORD.y<0.0) return 1.0;
...
{   
    ...
    float temp = 0.0;
    float temp2 = 0.0;
    float coordw = GL_TEXCOORD.x + dw*dd;
    float coordh = GL_TEXCOORD.y + dh*dd;
    float coordw2 = GL_TEXCOORD.x - dw*dd;
    float coordh2 = GL_TEXCOORD.y - dh*dd;
