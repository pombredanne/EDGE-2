...
namespace eve
{
    namespace matrix
    {
        ...
        struct scale : nocopy
        {
            ...
            explicit scale( const eve::vec3 &_v ) : v(_v), is_valid( v.x != 0.f && v.y != 0.f && v.z != 0.f )
            {
                if( is_valid )
                    glScalef( v.x, v.y, v.z );
            }
            ...
            protected: eve::vec3 v; bool is_valid;
        };

        struct translate : nocopy
        {
            explicit translate( const eve::vec3 &_v ) : v( _v )
            {
            ...
            protected: eve::vec3 v;
            static eve::vec3 position;
        };

#if 0
        struct offset : nocopy
        {
            offset( const eve::vec3 &v )
            {
                GLfloat matrix[16];
        ...
        {
            explicit inc_translate( const eve::vec3 &v )
            {
                glTranslatef( v.x, v.y, v.z );
            }
        };
